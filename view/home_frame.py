...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.connect_pushButton.setStyleSheet(u"background:rgb(177, 255, 125)")
        ...
        self.set_zero_pushButton.setStyleSheet(u"background:rgb(177, 255, 125)")
        self.start_pushButton = QPushButton(self.centralwidget)
        self.start_pushButton.setObjectName(u"start_pushButton")
        self.start_pushButton.setGeometry(QRect(1150, 90, 161, 51))
        self.start_pushButton.setFont(font2)
        self.start_pushButton.setStyleSheet(u"background:rgb(73, 213, 34)")
        self.stop_pushButton = QPushButton(self.centralwidget)
        self.stop_pushButton.setObjectName(u"stop_pushButton")
        self.stop_pushButton.setGeometry(QRect(1150, 180, 161, 51))
        self.stop_pushButton.setFont(font2)
        self.stop_pushButton.setStyleSheet(u"background:rgb(255, 63, 29)")
        self.save_pushButton = QPushButton(self.centralwidget)
        self.save_pushButton.setObjectName(u"save_pushButton")
        self.save_pushButton.setGeometry(QRect(1150, 270, 161, 51))
        self.save_pushButton.setFont(font2)
        self.save_pushButton.setStyleSheet(u"background:rgb(170, 255, 255)")
        ...
        self.logout_pushButton.setStyleSheet(u"background:rgb(255, 255, 255)")
        ...
        self.disconnect_pushButton.setStyleSheet(u"background:rgb(224, 255, 240)")
