...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.weight_label.setGeometry(QRect(770, 3, 141, 41))
        ...
        self.weight_lineEdit.setGeometry(QRect(770, 40, 131, 41))
        ...
        self.weight_unit_label.setGeometry(QRect(910, 40, 41, 41))
        ...
        self.set_zero_pushButton.setGeometry(QRect(1150, 120, 161, 51))
        ...
        self.start_pushButton.setGeometry(QRect(1150, 210, 161, 51))
        ...
        self.stop_pushButton.setGeometry(QRect(1150, 300, 161, 51))
        ...
        self.save_pushButton.setGeometry(QRect(1150, 390, 161, 51))
        ...
        self.calibrate_weight_label = QLabel(self.centralwidget)
        self.calibrate_weight_label.setObjectName(u"calibrate_weight_label")
        self.calibrate_weight_label.setGeometry(QRect(940, 3, 161, 41))
        self.calibrate_weight_label.setFont(font1)
        self.calibrate_weight_lineEdit = QLineEdit(self.centralwidget)
        self.calibrate_weight_lineEdit.setObjectName(u"calibrate_weight_lineEdit")
        self.calibrate_weight_lineEdit.setGeometry(QRect(950, 40, 131, 41))
        self.calibrate_weight_lineEdit.setFont(font2)
        self.calibrate_weight_lineEdit.setStyleSheet(u"background:rgb(255, 255, 255)")
        self.calibrate_weight_lineEdit.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.calibrate_weight_unit_label = QLabel(self.centralwidget)
        self.calibrate_weight_unit_label.setObjectName(u"calibrate_weight_unit_label")
        self.calibrate_weight_unit_label.setGeometry(QRect(1090, 40, 41, 41))
        self.calibrate_weight_unit_label.setFont(font1)
        self.calibrate_pushButton = QPushButton(self.centralwidget)
        self.calibrate_pushButton.setObjectName(u"calibrate_pushButton")
        self.calibrate_pushButton.setGeometry(QRect(1150, 30, 161, 51))
        self.calibrate_pushButton.setFont(font2)
        self.calibrate_pushButton.setStyleSheet(u"background-color: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop: 0 #ff667a, stop: 1 #ffffff);")
        self.calibrate_pushButton.setAutoRepeatDelay(300)
        self.calibrate_pushButton.setAutoRepeatInterval(100)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.calibrate_weight_label.setText(QCoreApplication.translate("MainWindow", u"\u0e19\u0e49\u0e33\u0e2b\u0e19\u0e31\u0e01Calibrate", None))
        self.calibrate_weight_unit_label.setText(QCoreApplication.translate("MainWindow", u"KG", None))
        self.calibrate_pushButton.setText(QCoreApplication.translate("MainWindow", u"CALIBRATE", None))
    # retranslateUi
