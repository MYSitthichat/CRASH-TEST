...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.weight_label.setGeometry(QRect(770, 20, 141, 41))
        ...
        self.weight_lineEdit.setGeometry(QRect(930, 20, 131, 41))
        ...
        self.weight_unit_label.setGeometry(QRect(1080, 20, 41, 41))
        ...
        self.set_zero_pushButton.setGeometry(QRect(1150, 20, 161, 51))
        ...
        self.start_pushButton.setGeometry(QRect(1150, 110, 161, 51))
        ...
        self.stop_pushButton.setGeometry(QRect(1150, 200, 161, 51))
        ...
        self.save_pushButton.setGeometry(QRect(1150, 290, 161, 51))
        ...
        self.data_show_textEdit = QTextEdit(self.centralwidget)
        self.data_show_textEdit.setObjectName(u"data_show_textEdit")
        self.data_show_textEdit.setGeometry(QRect(10, 89, 1120, 780))
        font3 = QFont()
        font3.setFamilies([u"TH Niramit AS"])
        font3.setPointSize(30)
        font3.setBold(True)
        self.data_show_textEdit.setFont(font3)
        self.data_show_textEdit.setStyleSheet(u"background:rgb(255, 255, 255)")
        self.data_show_textEdit.setFrameShape(QFrame.Shape.Box)
        self.data_show_textEdit.setFrameShadow(QFrame.Shadow.Plain)
        self.data_show_textEdit.setLineWidth(4)
